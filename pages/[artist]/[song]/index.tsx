...
import { AlbumArt, AuctionInfo, BidAndHistory, ReleaseDetails } from "modules/song"
...
const Song = ({ artist, song, slug }: any) => {
  ...
  return (
    <FadeInOut key={release?.name}>
      <AlbumArt release={release} />
      <ReleaseDetails release={release} auction={auction} />
      <div className={"mt-12 flex flex-col gap-10 sm:grid sm:grid-cols-[4fr,6fr] mx-auto w-11/12 pt-16 sm:w-4/5"}>
