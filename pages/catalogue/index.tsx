...
const Catalogue = () => {
  ...
  const handlePlay = (random: object) => {
  ...
  return (
    <div className="absolute top-0 left-0 m-0 mx-auto box-border h-full w-screen min-w-0">
      <div className="m-0 mx-auto box-border w-screen min-w-0">
        <div className="sticky top-0 z-0 grid h-screen w-screen place-items-center bg-slate-500">
        ...
        <div className="relative mx-auto flex w-full flex-col bg-slate-500">
          {catalogue.length > 0 ? (
